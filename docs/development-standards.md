...
Referencia de las decisiones de diseño detrás de este template: documenta el criterio ya aplicado en este mismo repo, para que un proyecto nuevo clonado a partir de él arranque con estas decisiones ya tomadas en vez de re-derivarlas.
